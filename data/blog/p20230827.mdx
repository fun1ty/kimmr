...
by의 확장으로 그룹함수에 의해 컬럼값이 소계나 총합 등 집계된 데이터일 경우 1을 반환하고 그게 아닌
경우 0을 반환한다. CASE/DECODE를 이용해, 소계를 나타내는 필드에 원하는 문자열을 지정할 수 있다.
(DECODE는 표준sql이 아니므로 CASE WHEN 구문의 사용을 더 권장한다.)
...
<Image alt="grouping" src="/static/images/grouping.jpg" width={300} height={550} />
